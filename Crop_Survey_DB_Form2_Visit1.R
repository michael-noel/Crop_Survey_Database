...
# Crop growth ------------------------------------------------------------------
tillers_Q1 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 9, startCol = 5,
  endRow = 9, endCol = 5, header = FALSE)
...
HQ <- rep(1:10)
tillers <- data.frame(HQ,
                      rbind(tillers_Q1, tillers_Q2, tillers_Q3, tillers_Q4,
                            tillers_Q5, tillers_Q6, tillers_Q7, tillers_Q8,
                            tillers_Q9, tillers_Q10))

leaves.Q1 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 5,
 endRow = 11, endCol = 5, header = FALSE)
names(leaves.Q1) <- "Leaves.Q1"

leaves.Q2 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 6,
 endRow = 11, endCol = 6, header = FALSE)
names(leaves.Q2) <- "Leaves.Q2"

leaves.Q3 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 7,
 endRow = 11, endCol = 7, header = FALSE)
names(leaves.Q3) <- "Leaves.Q3"

leaves.Q4 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 8,
 endRow = 11, endCol = 8, header = FALSE)
names(leaves.Q4) <- "Leaves.Q4"

leaves.Q5 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 9,
 endRow = 11, endCol = 9, header = FALSE)
names(leaves.Q5) <- "Leaves.Q5"

leaves.Q6 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 10,
 endRow = 11, endCol = 10, header = FALSE)
names(leaves.Q6) <- "Leaves.Q6"

leaves.Q7 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 11,
 endRow = 11, endCol = 11, header = FALSE)
names(leaves.Q7) <- "Leaves.Q7"

leaves.Q8 <- readWorksheet(wb,  "Form 2 Visit 1", startRow = 11, startCol = 12,
 endRow = 11, endCol = 12, header = FALSE)
names(leaves.Q8) <- "Leaves.Q8"

leaves.Q9 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 13,
 endRow = 11, endCol = 13, header = FALSE)
names(leaves.Q9) <- "Leaves.Q9"

leaves.Q10 <- readWorksheet(wb, "Form 2 Visit 1", startRow = 11, startCol = 14,
  endRow = 11, endCol = 14, header = FALSE)
names(leaves.Q10) <- "Leaves.Q10"

leaves <- cbind()

crop_growth <- cbind(leaves.Q1, leaves.Q2, leaves.Q3, leaves.Q4, leaves.Q5,
                          leaves.Q6, leaves.Q7, leaves.Q8, leaves.Q9, leaves.Q10)
print(CROP.INFO)

#  =  =  =  =  =  =  =  =  =  = WEEDS =  =  =  =  =  =  =  =  =  =

weed.aboveA <- readWorksheet(wb,
   "Form 2 Visit 1",
   startRow = 17,
   startCol = 3,
   endRow = 17,
